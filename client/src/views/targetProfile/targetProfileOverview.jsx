                ...
                <div className="flex" style={{minWidth: '1600px'}}>
                    ...
                    <div className="pl3 pr4" style={{width: '350px'}}>
                        ...
                        <FunctionalAnnotation
                            uniprotId={this.props.cellLine.uniprot_metadata?.uniprot_id}
                        />
                        ...
                        />
                        <LocalizationAnnotations annotation={this.props.cellLine.annotation}/>
                        ...
                        <div className="w-100 pb3 expression-plot-container">
                            <ExpressionPlot
                                rnaAbundance={this.props.cellLine.abundance_data?.rna_abundance}
                                proteinAbundance={this.props.cellLine.abundance_data?.protein_concentration}
                            />
                        </div>
                    ...
                    <div className="pt3" style={{width: '600px'}}>
                        ...
                        <ViewerContainer
                            ...
                            targetName={this.props.cellLine.metadata.target_name}
                        ...
                        {this.props.showTargetAnnotator ? (
                            ...
                            <>
                                <SectionHeader
                                    ...
                                    popoverContent={popoverContents.massSpecTargetPageHeader}
                                />
                                <MassSpecContainer
                                    layout='tabs'
                                    ensgId={this.props.cellLine.metadata.ensg_id}
