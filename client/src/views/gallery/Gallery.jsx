    ...
    return (
        <div
            ...
            <div className='pa3 lightbox-content-container'>
                <div className='f3'>
                    Microscopy images for <Link to={`/target/${props.cellLineId}`} target='_blank'>
                        {props.targetName}
                    </Link>
                </div>
                <ViewerContainer
...
function Thumbnail (props) {
    ...
    return (
        <div className='gallery-thumbnail-container'>
            ...
            />
            <div
                className='gallery-thumbnail-caption'
                onClick={() => props.onThumbnailCaptionClick(metadata)}
            >
                <div className='f5 b'>{`${metadata.target_name}`}</div>
        ...
        return (
            <>
                <div className="pa4 w-100">
                    ...
                    <SectionHeader
                        title='OpenCell microscopy gallery'
                        fontSize='f3'
                    ...
                    <div className="pl4 flex items-center">
                        ...
                        <div className='pt3'>
                            <div
                                className='f5 pl2 pr2 simple-button'
