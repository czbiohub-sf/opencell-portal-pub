...
export default class MassSpecNetworkContainer extends Component {
    ...
    constructor (props) {
        ...
        this.state = {
            ...
            // whether to show the saved network
            // currently, saved networks are not used, so this is always false
            ...
            colaEdgeLength: 1,
            colaNodeSpacing:  window.devicePixelRatio > 1 ? 5 : 15,
        };
    ...
    async initializeNetwork () {
        ...
        try {
            // HACK: manually set the size of the cytoscape container using a hard-coded size of 580px,
            // which is equal to the hard-coded size of the cytoscape-container minus its padding
            // this is the only way I could find to programmatically set the size of the cytoscape
            // component itself after the component has initially rendered 
    ...
    render () {
        ...
        return (
            <div className='relative'>
                ...
                {this.state.loadingError ? <div className='f2 tc loading-overlay'>No interaction data</div> : (null)}
                {!this.state.loaded ? <div className='f2 tc loading-overlay'>Loading...</div> : (null)}

                {/* display controls */}
                <div className='cytoscape-controls-container'>
